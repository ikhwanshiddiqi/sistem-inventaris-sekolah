<?php
/**
 * Change Password Admin - Sistem Inventaris Sekolah
 */
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p class="text-muted mb-0">Ganti password akun Anda dengan yang baru</p>
                    </div>
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-lock me-2"></i>Form Ubah Password
                </h5>
            </div>
            <div class="card-body">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h6 class="mb-0">
                    <i class="fas fa-shield-alt me-2"></i>Kekuatan Password
                </h6>
            </div>
            <div class="card-body">
                <div class="mb-2">
