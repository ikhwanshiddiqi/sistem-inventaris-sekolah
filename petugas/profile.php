<?php
/**
 * Profile Petugas - Sistem Inventaris Sekolah
 */

$page_title = 'Profile Petugas';
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h2 class="mb-2 fw-bold">
                            <i class="fas fa-user me-2 text-primary"></i>Profile Petugas
                        </h2>
                    ...
                    <div class="col-md-4 text-md-end">
                        <a href="change-password.php" class="btn btn-warning shadow-sm">
...
<div class="row">
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="foto" class="form-label fw-semibold">Foto Profile</label>
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-light">
                <h5 class="mb-0 fw-bold">
                    <i class="fas fa-user-circle me-2 text-primary"></i>Preview Profile
                </h5>
            </div>
            <div class="card-body text-center">
                <div class="mb-3">
                    ...
                    <?php else: ?>
                        <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mx-auto shadow-sm" 
                ...
                <div class="row text-start">
                    <div class="col-12 mb-2">
                        <small class="text-muted fw-semibold">Email:</small><br>
                        <span><?= htmlspecialchars($user['email']) ?></span>
                    </div>
                    
                    <div class="col-12 mb-2">
                        <small class="text-muted fw-semibold">Role:</small><br>
                    ...
                    <div class="col-12">
                        <small class="text-muted fw-semibold">Bergabung sejak:</small><br>
